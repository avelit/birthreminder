package birthreminder.config;

import com.mongodb.Mongo;
import birthreminder.domain.util.JSR310DateConverters.*;
...
@Configuration
@EnableMongoRepositories("birthreminder.repository")
...
public class CloudMongoDbConfiguration extends AbstractMongoConfiguration  {
    ...
    public CustomConversions customConversions() {
        ...
        converterList.add(ZonedDateTimeToLocalDateConverter.INSTANCE);
        converterList.add(LocalDateToZonedDateTimeConverter.INSTANCE);
